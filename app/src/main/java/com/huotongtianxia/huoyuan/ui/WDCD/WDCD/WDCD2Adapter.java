...
public class WDCD2Adapter extends BaseAdapter {
    private Context context;
    private List<WDCD2Bean.DataBean> list = null;
    private LayoutInflater inflater;

    public WDCD2Adapter(Context context, List<WDCD2Bean.DataBean> list) {
